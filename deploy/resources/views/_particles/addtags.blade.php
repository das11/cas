            ...
            <div class="col-12 col-lg-3 justify-content-center">
                <div class="dashsidepanel shadow text-center mb-4" style="background-color : #ededed; border-radius : 10px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); padding : 10px">
                  ...
                  <ul class="list-group list-group-flush p-3 mt-3 text-left font-weight-bold">
                    ...
                    <li class="list-group-item active"><a href="/addtags" style="color:white">Add Tags</a></li>
            ...
            <div class="col-xs-12 col-md-9 col-lg-9">
                <div class="row">
                    <div class="col-12 mt-4 mb-4 d-flex justify-content-center">
                        <h1 class="avds_title" style="color : black">Tags</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="gymlisting p-2">
                            ...
                            {!! Form::open(array('url' => 'pushaddtag','class'=>'','id'=>'signup','role'=>'form', 'enctype' => 'multipart/form-data')) !!}
							<form action="#" id="contact_form" class="contact_form">

                                <div class="form-group row">
									
                                    <input name="name" id="contact_company" placeholder="New Tag Name" type="text"  class="form-control col-md-5">

                                    &nbsp;

                                    <input name="slug" id="contact_company" placeholder="Tag Slug" type="text"  class="form-control col-md-4">
